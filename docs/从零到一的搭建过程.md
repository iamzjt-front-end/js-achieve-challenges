...
- [从零到一的搭建过程](#从零到一的搭建过程)
_ [1. 项目基础目录结构](#1-项目基础目录结构)
_ [2. 配置 .editorconfig](#2-配置-editorconfig)
_ [3. 配置 .gitignore](#3-配置-gitignore)
_ [4. 引入 ESLint](#4-引入-eslint)
_ [5. 引入 Prettier](#5-引入-prettier)
_ [6. 引入 Husky](#6-引入-husky)
_ [7. 引入 lint-staged](#7-引入-lint-staged)
_ [8. 引入 commitlint](#8-引入-commitlint)
_ [9. 引入 commitizen](#9-引入-commitizen)
_ [10. 自定义 commitizen](#10-自定义-commitizen)
_ [11. 引入 ts 环境](#11-引入-ts-环境)
_ [12. 引入 vitest](#12-引入-vitest)
_ [13. 引入 Vitest UI](#13-引入-vitest-ui)
_ [14. 添加 .eslintignore 配置](#14-添加-eslintignore-配置)
_ [15. 引入 release-it](#15-引入-release-it)
_ [16. 出现的问题](#16-出现的问题)
<!-- TOC -->
